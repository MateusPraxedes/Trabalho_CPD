...
def inicializa_interface():
    ...
    btn_busca_jogo = tk.Button(button_frame, text="Busca Específica", bg="#333", fg="white", font=("Helvetica", 12), width=15, height=2, relief="flat", bd=0, command=lambda: print("Button 4 clicked"))
    btn_busca_jogo.grid(row=4, column=0, padx=20, pady=15, columnspan=1, sticky="nsew")
